...
import type { AttachmentMetadata } from 'chrome-ai-bridge-shared';
 ...
 *
 * mô tả tiếng Việt: dịch vụphiênlập lịch,  CLI/SDK triển khai.
 * thông qua Engine giao diệntriển khaiphụ thuộc, thêm mớiengine HTTP .
 */
