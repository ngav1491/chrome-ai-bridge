...
REM Windows: %LOCALAPPDATA%\chrome-ai-bridge\logs
set "LOG_DIR=%LOCALAPPDATA%\chrome-ai-bridge\logs"
...
if not defined NODE_EXEC (
    ...
    echo To fix: Set CHROME_MCP_NODE_PATH environment variable or run 'chrome-ai-bridge doctor --fix' >> "%WRAPPER_LOG%"
    exit /B 1
)
