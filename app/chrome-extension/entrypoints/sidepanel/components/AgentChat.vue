...
import type { OpenProjectTarget } from 'chrome-ai-bridge-shared';
...
const currentManagementInfo = ref<import('chrome-ai-bridge-shared').AgentManagementInfo | null>(
  null,
);
