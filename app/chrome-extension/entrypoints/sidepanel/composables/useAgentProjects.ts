...
import type { AgentProject, AgentStoredMessage } from 'chrome-ai-bridge-shared';
    ...
    try {
      ...
      if (existingProject) {
        ...
        const shouldSwitch = confirm(
          `thư mục "${validation.absolute}" tồn tại: ${existingProject.name}\n\n` +
            `có/khôngchuyển đổi?\n\n` +
