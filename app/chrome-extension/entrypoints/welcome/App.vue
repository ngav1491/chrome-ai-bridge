...
const COMMANDS = {
  npmInstall: 'npm install -g chrome-ai-bridge',
  pnpmInstall: 'pnpm add -g chrome-ai-bridge',
  yarnInstall: 'yarn global add chrome-ai-bridge',
  mcpUrl: 'http://127.0.0.1:' + NATIVE_HOST.DEFAULT_PORT + '/mcp',
  doctor: 'chrome-ai-bridge doctor',
  fix: 'chrome-ai-bridge doctor --fix',
  report: 'chrome-ai-bridge report --copy',
} as const;
        ...
        <div class="max-w-3xl mx-auto space-y-6">
          <section class="welcome-card welcome-card--primary p-6">
            <h2 class="welcome-title text-xl font-medium">
              Install <code class="welcome-code">chrome-ai-bridge</code>
            </h2>
